...
| SHACL 1.2 (Core, SPARQL, node expressions, rules, SPARQL RL) | W3C shacl12-test-suite | 280 | 267 | 267 | 0 | GREEN |
| SHACL (first-party corpus) | first-party frozen reports | 72 | 0 | 0 | 0 | GREEN |
| SHACL prepared-product equivalence | W3C data-shapes + shacl12-test-suite + first-party corpus | 335 | 0 | 0 | 0 | GREEN |
