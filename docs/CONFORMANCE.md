...
| HNSW approximate kNN (first-party) | purrdf-hnsw (first-party) | 71 | 0 | 0 | 0 | GREEN |
...
| SHACL prepared-product equivalence | W3C data-shapes + first-party corpus | 192 | 0 | 0 | 0 | GREEN |
...
| Python binding suite | first-party (incl. compat differential vs rdflib) | 931 | 4 | 4 | 0 | GREEN |
...
| Python binding suite | first-party, compat differential vs rdflib 7.6 included | **931** pass · 4 strict-xfail (ledgered). The count is the WHOLE binding suite — entailment, GTS, projections, shapes — not the rdflib differential alone; the 4 ledgered entries are that differential's |
