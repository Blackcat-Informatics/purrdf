...
| XSD/XPath regExp (first-party corpus) | first-party, XSD G + F&O 5.6 | 197 | 0 | 0 | 0 | GREEN |
...
- `crates/rdf-core/corpus/xsd-regex/` — PurRDF's own XSD/XPath `regExp` corpus:
  197 cases across six `.cases` files, grading
