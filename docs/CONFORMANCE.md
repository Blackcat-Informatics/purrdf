...
| purrdf.compat parity | first-party (differential vs rdflib) | 495 | 4 | 4 | 0 | GREEN |
...
| purrdf.compat parity | first-party differential vs rdflib 7.6 | **495** pass · 4 strict-xfail (ledgered) |
