...
| purrdf.compat parity | first-party (differential vs rdflib) | 426 | 4 | 4 | 0 | GREEN |
...
| purrdf.compat parity | first-party differential vs rdflib 7.6 | **426** pass · 4 strict-xfail (ledgered) |
