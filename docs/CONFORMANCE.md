...
| Python binding suite | first-party (incl. compat differential vs rdflib) | 836 | 4 | 4 | 0 | GREEN |
...
| Python binding suite | first-party, compat differential vs rdflib 7.6 included | **836** pass · 4 strict-xfail (ledgered). The count is the WHOLE binding suite — entailment, GTS, projections, shapes — not the rdflib differential alone; the 4 ledgered entries are that differential's |
