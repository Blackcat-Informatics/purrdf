...
| SPARQL 1.1/1.2 evaluation (full corpus) | W3C sparql11 + sparql12 + first-party | 831 | 5 | 5 | 0 | GREEN |
| SPARQL execution governors | purrdf-sparql-governors (first-party) | 49 | 0 | 0 | 0 | GREEN |
...
| Python binding suite | first-party (incl. compat differential vs rdflib) | 598 | 4 | 4 | 0 | GREEN |
...
| Python binding suite | first-party, compat differential vs rdflib 7.6 included | **598** pass · 4 strict-xfail (ledgered). The count is the WHOLE binding suite — entailment, GTS, projections, shapes — not the rdflib differential alone; the 4 ledgered entries are that differential's |
