...
They live under `crates/*/benches/`. The workspace registers 78 `[[bench]]`
...
This table documents 22 of the 78 `[[bench]]` targets registered across the
...
| --- | --- |
| `shacl_validate/corpus_all` | All 71 committed first-party conformance cases, including text ingestion, shapes parsing, target resolution, constraint evaluation, and report assembly. |
...
force serial and parallel execution across all 71 corpus cases, 2- and 4-worker
