...
`purrdf-iri`, `purrdf-xsd`, `purrdf-events`, `purrdf-wasm`) exist for
...
- [The Interned Dataset IR](../concepts/interned-dataset.md) — how the IR works
  and why it is fast.
- [Graph, Tabular & Research-Object Projections](../concepts/projections.md) — deterministic LPG,
  CSVW, OBO Graphs, SKOS, and research-object carriers through the umbrella crate.
