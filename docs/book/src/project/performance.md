...
| --- | --- | --- |
| **Rust criterion suites** | Native engine hot paths — IR layout, copy-on-write mutation, pack index alternatives, codecs, graph/tabular projections, SPARQL lexing/evaluation/planning, SHACL validation, entailment chase, GTS authoring, IRI parsing. | `make bench` |
