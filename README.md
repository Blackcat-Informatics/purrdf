...
- **Entailment** — Simple/RDF/RDFS/OWL-RL/D forward materialization over a
  ...
  scores **20 of 27 positive and 23 of 23 negative**, the latter meaning no
...
| Entailment (OWL 2 RL, W3C entailment tests) | vendored W3C OWL 2 entailment suite | **43 / 50** agreeing, 7 ledgered, 0 unledgered — negative lane **23 / 23** (no unsoundness), positive lane **20 / 27** |
