...
- **Entailment** — Simple/RDF/RDFS/OWL-RL/D forward materialization over a
  ...
  scores **26 of 27 positive and 23 of 23 negative**, the latter meaning no
...
| Entailment (OWL 2 RL, W3C entailment tests) | vendored W3C OWL 2 entailment suite | **49 / 50** agreeing, 1 ledgered, 0 unledgered — negative lane **23 / 23** (no unsoundness), positive lane **26 / 27** |
