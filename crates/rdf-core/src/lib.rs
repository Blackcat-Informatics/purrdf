...
pub use ir::embedding::*;
pub use ir::{
    BlankScope, BudgetExceeded, CANON_PROFILE_ID, CANON_PROFILE_VERSION, CanonError, CanonHash,
    Canonicalized, CountingDemandProvider, DatasetDiff, DatasetSink, FrozenDatasetSource,
    ...
    RdfDatasetVisitor, RdfEnvelope, ReservedVocabulary, SubsetPageProvider, TermId, TermPosition,
    TermRef, TermValue, ValidatedRdfDatasetBuilder, canonicalize, canonicalize_with,
    check_admissible, dataset_diff, datasets_isomorphic, try_canonicalize, try_canonicalize_with,
};
pub use ir::{
...
pub use loss::{
    ...
    pair_loss_ledger, profile_for, rdf_gts_loss_matrix_json, rdf_to_csvw_terms_loss_ledger,
    ...
    registered_pairs, research_object_to_rdf_loss_ledger, schema_to_shacl_loss_ledger,
};
pub use model::{
