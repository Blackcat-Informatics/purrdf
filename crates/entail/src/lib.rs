...
pub use entails::{
    Binding, CertainAnswers, ComprehensionWarrant, DataRangeWarrant, EntailmentCertificate,
    EntailmentMechanism, EntailmentOutcome, EntailmentWarrant, FREEZE_BUDGET, FreezeWarrant,
    FrozenInstance, FrozenOutcome, Generalization, HomomorphismWarrant, ImportMap, MATCH_BUDGET,
    MissReason, NegativeFact, REFUTATION_BUDGET, ReflexivityWarrant, Refutation, RefutationWarrant,
    UndecidedReason, VarKey, certain_answers, entails, verify,
};
pub use explain::{
