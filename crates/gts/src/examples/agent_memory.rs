...
const CONFIDENCE: &str = "https://blackcatinformatics.ca/purrdf/confidence";
const ACCORDING_TO: &str = "https://blackcatinformatics.ca/purrdf/accordingTo";
const SOURCE_LOCATION: &str = "https://blackcatinformatics.ca/purrdf/sourceLocation";
const WAS_DERIVED_FROM: &str = "https://blackcatinformatics.ca/purrdf/wasDerivedFrom";
const DCT_CREATED: &str = "http://purl.org/dc/terms/created";
const TOOL_CALL: &str = "https://blackcatinformatics.ca/purrdf/ToolCall";
const SOFTWARE_AGENT: &str = "https://blackcatinformatics.ca/purrdf/SoftwareAgent";
const USED_TOOL: &str = "https://blackcatinformatics.ca/purrdf/usedTool";
const TOOL_ARGUMENTS: &str = "https://blackcatinformatics.ca/purrdf/toolArguments";
const TOOL_RESULT: &str = "https://blackcatinformatics.ca/purrdf/toolResult";
const CALLED_BY_INVOCATION: &str = "https://blackcatinformatics.ca/purrdf/calledByInvocation";
const WAS_GENERATED_BY: &str = "https://blackcatinformatics.ca/purrdf/wasGeneratedBy";
